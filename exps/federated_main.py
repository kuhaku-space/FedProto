    ...
    for round in tqdm(range(args.rounds)):
        ...
        for idx in idxs_users:
            ...
            summary_writer.add_scalar(
                "Train/Loss/user" + str(idx + 1), loss["total"], round
            )
            summary_writer.add_scalar(
                "Train/Loss1/user" + str(idx + 1), loss["1"], round
            )
            summary_writer.add_scalar(
                "Train/Loss2/user" + str(idx + 1), loss["2"], round
            )
...
def FedProto_modelheter(
    args: Any,
    train_dataset: Any,
    test_dataset: Any,
    user_groups: dict[int, Any],
    user_groups_lt: dict[int, Any],
    local_model_list: list[Any],

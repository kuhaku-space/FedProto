...
def visualize(args: Any, x: np.ndarray, y: np.ndarray) -> None:
    ...
    plt.subplots_adjust(
        left=None, bottom=0.15, right=None, top=None, wspace=0.1, hspace=0.15
    )
...
x = np.load(
    "/Users/tanyue/Desktop/saved/protos/" + args.alg + "_protos.npy", allow_pickle=True
)
y = np.load(
    "/Users/tanyue/Desktop/saved/protos/" + args.alg + "_labels.npy", allow_pickle=True
)
